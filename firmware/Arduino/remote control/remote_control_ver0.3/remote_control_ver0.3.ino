...
void loop()
{
  ...
  /*******************************************************/
  /*******************************************************/
  byte vai_avanti[2] = {'1', 255};
  byte vai_indietro[2] = {'2', 255};
  byte vai_sinistra[2] = {'3', 255};
  byte vai_destra[2] = {'4', 255};
  byte fermati[2] = {'0', 255};

  if (digitalRead(up) == LOW)
  {
    Serial.println("Vai avanti");
    //mySerial.write("a");
    mySerial.write(vai_avanti, 2);
    delay(100);
  }
  if (digitalRead(down) == LOW)
  {
    Serial.println("Vai dietro");
    //mySerial.write("a");
    mySerial.write(vai_indietro, 2);
    delay(100);
  }
  if (digitalRead(right) == LOW)
  {
    Serial.println("Vai destra");
    //mySerial.write("a");
    mySerial.write(vai_sinistra, 2);
    delay(100);
  }
  if (digitalRead(left) == LOW)
  { Serial.println("Vai sinistra");
    //mySerial.write("a");
    mySerial.write(vai_destra, 2);
    delay(100);
  }

  mySerial.write(fermati, 2);
  delay(100);
