...
#ifdef SERIAL_DEBUG
  Serial.print("Turn reversed:  ");
  Serial.println(pwm);
#endif

  motorMove(TURN_REVERSE, pwm, NONE);
...
void motorTurnItSelf(int pwm)
{
  ...
  // Setting the inputs in order to reverse the rover
  digitalWrite(MOTOR_PIN_AM1, LOW);
  digitalWrite(MOTOR_PIN_BM1, HIGH);
  digitalWrite(MOTOR_PIN_AM2, LOW);
  digitalWrite(MOTOR_PIN_BM2, HIGH);
...
{
#ifdef SERIAL_DEBUG
  Serial.print("Turn right itself speed:  ");
  Serial.println(pwm);
#endif
...
{
#ifdef SERIAL_DEBUG
  Serial.print("Turn left itself speed:  ");
  Serial.println(pwm);
#endif
