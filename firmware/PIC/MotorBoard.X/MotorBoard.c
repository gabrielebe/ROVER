...
#define ADDR_BASE   0b01010000

#ifndef ADDR_PIN1
#define ADDR_PIN1           (PORTBbits.RB0)
#define ADDR_PIN1_DIR       (TRISBbits.TRISB0)
#endif

#ifndef ADDR_PIN2
#define ADDR_PIN2           (PORTBbits.RB1)
#define ADDR_PIN2_DIR       (TRISBbits.TRISB1)
#endif
