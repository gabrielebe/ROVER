 ...
 * Author: Harpal
 *
 * Created on 24 dicembre 2014, 10.51
 */

//Start by checking if the config header has already been defined or not
#ifndef CONFIG_H
#define	CONFIG_H
#include <xc.h>
// PIC18F47J53 Configuration Bit Setting
// CONFIG1L
...
//declaration of all the libraries needed in the project
#define _XTAL_FREQ 12000000     //defining the work frequancy. needed for the delay generation
